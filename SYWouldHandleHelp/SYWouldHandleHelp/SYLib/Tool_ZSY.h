...
#define SYMessage(...) {NSString *message = [NSString stringWithFormat:__VA_ARGS__];[SYPrompt showMessage:message];}
#define SYAlert(...) {NSString *message = [NSString stringWithFormat:__VA_ARGS__];[SYPrompt showAlertMessage:message];}
 ...
 *  回调有一个BOOL参数 一个obj参数
 */
typedef void(^BackRefreshSuccessParamBlock)(BOOL success, id param);
